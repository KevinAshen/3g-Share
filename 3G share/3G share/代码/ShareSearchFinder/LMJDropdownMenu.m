...
- (void)createMainBtnWithFrame:(CGRect)frame{
    ...
    [_mainBtn setTitle:@"原创作品" forState:UIControlStateNormal];
    ...
    _mainBtn.titleLabel.font    = [UIFont systemFontOfSize:12];
    ...
    // 旋转尖头
    _arrowMark = [[UIImageView alloc] initWithFrame:CGRectMake(_mainBtn.frame.size.width - 25, 0, 15, 15)];
    _arrowMark.center = CGPointMake(VIEW_CENTER_X(_arrowMark), VIEW_HEIGHT(_mainBtn)/2);
    _arrowMark.image  = [UIImage imageNamed:@"cai"];
